    ...
    posttable: async (ctx) => {
       ...
       postclass:async(ctx) => {
        ...
        //    console.log(applyclass.c_person);
           let classInfo = { c_id: info.class_id, u_id: info.user_id, t_result: info.result, c_name: applyclass.c_name, c_media: applyclass.c_media, c_person: applyclass.c_person }
